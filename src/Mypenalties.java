 ...
 * @author dell
 */
public class Mypenalties extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        View.setSurrendersFocusOnKeystroke(true);
        jScrollPane1.setViewportView(View);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel1.setText("My Penalties");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mypenalties.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Mypenalties().setVisible(true);
            }
        });
    }
