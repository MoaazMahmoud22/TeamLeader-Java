 ...
 * @author USER
 */
public class tmassignreport extends javax.swing.JFrame {

    /**
     * Creates new form tmassignreport
     */
    public tmassignreport() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        Team_leader tassirepbacx= new Team_leader();
        tassirepbacx.show();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tmassignreport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tmassignreport().setVisible(true);
            }
        });
    }
